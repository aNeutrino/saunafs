...
public:
	...
	// /// So far the in-memory implementation doesn't need it, so it does nothing here. But provides
	// /// the extensibility point for subclasses.
	// /// @see IFilesystemOperations::attachReadOnlyTransactionToContext
	// void attachReadOnlyTransactionToContext(FsContext &context) override {
	// 	(void)context;  // Unused parameter in this implementation
	// }

	// /// Attaches a Read Write Transaction to the given context.
	// /// @see IFilesystemOperations::attachReadWriteTransactionToContext
	// void attachReadWriteTransactionToContext(FsContext &context) override {
	// 	(void)context;  // Unused parameter in this implementation
	// }
