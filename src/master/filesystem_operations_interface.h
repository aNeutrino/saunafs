...
public:
	...
	// /// Attaches a Read Only Transaction to the given context.
	// /// Some implementations based on key-value stores may require grouping multiple operations
	// /// into a single atomic transaction.
	// /// Could be ignored by implementations not based on key-value stores.
	// /// @param context The filesystem operation context to which the transaction will be attached.
	// virtual void attachReadOnlyTransactionToContext(FsContext &context) = 0;

	// /// Attaches a Read Write Transaction to the given context.
	// /// Similar to the Read Only version, but for read-write transactions.
	// virtual void attachReadWriteTransactionToContext(FsContext &context) = 0;
